        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form action="{{ route('ad.partner.update', $partner) }}" method="POST" @submit.prevent="onSubmit" enctype="multipart/form-data">
                        @method('Put')
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Nhập tên đối tác...." v-validate="'required'" data-vv-as="&quot;Tên&quot;" value="{{ old('name', $partner->name) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="fileinput fileinput-{{ $partner->image ? 'exists' : 'new' }}" data-provides="fileinput">
                                            ...
                                            <div class="fileinput-preview fileinput-exists thumbnail" style="height: 200px">
                                                @if($partner->image)
                                                    <img class="img-responsive" src="{{ $partner->image }}" alt="Preview banner"/>
                                                @endif
                                            </div>
                                            <div>
                                ...
                                <div class="form-group" :class="[errors.has('email') ? 'has-error' : '']">
                                    ...
                                    <input type="text" id="email" class="form-control" name="email" placeholder="Nhập email đối tác...." v-validate="'required'" data-vv-as="&quot;Email&quot;" value="{{ old('email', $partner->email) }}">
                                ...
                                <div class="form-group" :class="[errors.has('phone') ? 'has-error' : '']">
                                    ...
                                    <input type="text" id="phone" class="form-control" name="phone" placeholder="Nhập số điện thoại đối tác...." v-validate="'required'" data-vv-as="&quot;Số điện thoại&quot;" value="{{ old('phone', $partner->phone) }}">
                                ...
                                <div class="form-group" :class="[errors.has('address') ? 'has-error' : '']">
                                    ...
                                    <input type="text" id="address" class="form-control" name="address" placeholder="Nhập địa chỉ đối tác...." v-validate="'required'" data-vv-as="&quot;Địa chỉ&quot;" value="{{ old('address', $partner->address) }}">
                                    <span class="help-block" v-if="errors.has('address')">@{{ errors.first('address') }}</span>
                                </div>

                                <div class="form-group">
                                    <label for="url">Đường dẫn</label>
                                    <input type="text" id="url" class="form-control" name="url" placeholder="Nhập đường dẫn...." data-vv-as="&quot;Đường dẫn&quot;" value="{{ old('url', $partner->url) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" >
                                    ...
                                    <textarea id="description" class="form-control tinymce" name="description" >{!! old('description', $partner->description) !!}</textarea>
                                </div>
                            </div>
                        </div>
