            ...
            <div class="portlet light bordered">
                ...
                <table class="table">
                    ...
                    <thead>
                        <tr class="row">
                            <th style="vertical-align: text-top;">
                                <h4 style="font-weight:700">Câu hỏi: </h4>
                            </th>
                            <th>
                                <h4 style="font-weight:700">{{ $question->content}} ?</h4>
                            </th>
                        </tr>
                    </thead>
                    {{-- answers  --}}
                    <tbody>
                        <tr class="row">
                            <td  class="col-md-2">
                                <h4 style="font-weight:700">Câu trả lời:</h4>
                            </td>
                            <td class="col-md-10">
                                <form action="{{route('ad.question.answer',$question)}}" method="POST" id="formAnswer">
                                    ...
                                    <div id="newAnswer">
                                        <div class="row form-group">
                                            <div class="col-md-9" :class="[errors.has('text') ? 'has-error' : '']">
...
<script>
    ...
    $("#btnAdd").click(function(){
        ...
        if(answer){
            ...
            // cập nhật lại giá trị cho input thêm mới
            $(".answer").val('');            
        }else{
            Swal.fire({
                position: 'center',
