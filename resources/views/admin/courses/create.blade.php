        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form action="{{ route('ad.courses.store') }}" method="POST" @submit.prevent="onSubmit" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group" :class="[errors.has('price') ? 'has-error' : '']">
                                    ...
                                    <input type="number" class="form-control input-price" id="price" placeholder="ví dụ: 1000000" value="" name="price" v-validate="'required'" data-vv-as="&quot;Giá khóa học&quot;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-price-sale" id="price_sale" placeholder="ví dụ: 1000000 " value="" name="price_sale">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="time_sale"  value="" name="time_sale">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="exam_id_test" id="exam_id_test">
                                        @if ($list_exam_test->count())
                                            @foreach ($list_exam_test as $exam_test)
                                                <option value="{{$exam_test->id}}">{{$exam_test->name}}</option>
                                            @endforeach
                                        @else
                                            <option value="0">Chưa chọn</option>
                                        @endif
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group" :class="[errors.has('description') ? 'has-error' : '']">
                                    ...
                                    <textarea id="description" class="form-control" name="description" rows="3" v-validate="'required'" data-vv-as="&quot;Mô tả ngắn&quot;" placeholder="Nhập mô tả ngắn....">{{ old('description') }}</textarea>
                                    <span class="help-block" v-if="errors.has('description')">@{{ errors.first('description') }}</span>
                                </div>
                                <div class="form-group">
                                    <label for="keyword">Keywords</label>
                                    <input type="text" id="keyword" class="form-control" name="keyword" value="{{ old('keyword') }}" placeholder="Nhập từ khóa....">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" >
                                ...
                                <div class="form-group" >
                                    ...
                                    <textarea  type="text" id="describe" class="form-control tinymce" name="describe" placeholder="Nhập mô tả....">{!! old('describe') !!}</textarea>
                                </div>
                            </div>
                        </div>
