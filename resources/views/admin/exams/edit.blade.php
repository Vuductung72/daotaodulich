...
@section('page_title', 'Thêm câu hỏi cho bộ đề thi')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        @endif
                        <a class="btn btn-circle btn-default" href="{{ route('ad.exam.show',$exam) }}" title="">Quay lại</a>
                        <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:void(0);" title="Toàn màn hình"></a>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form action="{{ route('ad.exam.update',$exam) }}" method="POST" id="formAddNew" @submit.prevent="onSubmit">
                        @csrf
                        @method('PUT')
