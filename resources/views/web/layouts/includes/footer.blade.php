            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-3">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="tel:0345737858"><i class="fa-solid fa-phone"></i>0345737858</a></li>
                        <li><a href="mailto:info@daotaonghedulich.com"><i class="fa-solid fa-envelope"></i>info@daotaonghedulich.com</a></li>
                        <li class="text-white"><i class="fa-solid fa-clock"></i> 08:30-11:30, 13:30-16:30 <br> (Thứ 2 đến thứ 6)</li>
                    </ul>
                </div>
                <div class="col-12 col-lg-6 col-xl-3">
                ...
                <div class="col-12 col-lg-6 col-xl-3">
                    ...
                    <div class="connect-me-icon">
                        ...
                        <a href="https://www.youtube.com/@congtytuvanvaquanlyatm8533" target="_blank"><i class="fa-brands fa-youtube"></i></a>
                    </div>
                </div>
            </div>
        </div>
