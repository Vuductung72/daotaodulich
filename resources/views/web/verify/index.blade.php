    ...
    <div id="verify-email">
        <div class="container">
            <div class="form-verify-email">
                <form action="{{route('w.verify_email.check',customer()->user())}}" method="POST" id="email-verify">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group text-center">
                        ...
                        <button type="button" class="btn btn-danger btn-verification-code" data-url="{{route('w.verify_email.get')}}" disabled>Gửi mã xác thực</button> 
                        <div class="timeout">
