                                            ...
                                            <li class="collection-option">
                                                <div class="collection-information">
                                                    ...
                                                    <div class="thirdparty-icon MOMOPAY ">
                                                        <img src="{{ asset('web/asset/images/zalopay.svg') }}" alt="">
                                                    </div>
...
@push('scripts')
    <script>
        ...
        function submit_pay() {
            ...
            window.open("" + baseUrl + "/nap-tien/thanh-cong?amount=" + amount + "&type=zalopay", "_blank",
