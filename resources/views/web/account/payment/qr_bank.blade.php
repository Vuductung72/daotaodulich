                            ...
                            <div class="header-account">
                                <a href="{{route('w.payment.recharge')}}" class="rechange__back">
                                    <div class="btn--back d-flex">
                                        ...
                                        <div class="btn--title">
                                            <span>Quét mã Qr Số tài khoản</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                                            ...
                                            <li class="collection-option">
                                                <div class="collection-information">
                                                    ...
                                                    <div class="thirdparty-icon MOMOPAY ">
                                                        <img src="{{ asset('web/asset/images/icon-wbscan.svg') }}" alt="">
                                                    </div>
...
@push('scripts')
    <script>
        ...
        function submit_pay() {
            ...
            window.open("" + baseUrl + "/nap-tien/thanh-cong?amount=" + amount + "&type=qr_bank&code=" + e, "_blank",
